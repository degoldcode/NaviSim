...
plot "../agent.dat" u 3:4:2 w p pt 7 ps (10/SCALE)*0.3 lc palette t "", "../goals.dat" u 1:2:(1.):(col($4)) w circles fs solid border rgb "black" lc rgb var t "Goal", "../home.dat" u 1:2:(0.2) w circles fs solid border rgb "black" lc rgb "gray" t "Goal"
