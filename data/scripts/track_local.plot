...
set size square
SCALE = 8##(STATS_max+STATS_max/20.)*2.
OFFSETX = -2 ##-2.5
OFFSETY = 0 ##-2.5
...
plot "../agent.dat" u 3:(($1<=LAST && $1>=FIRST)?($4):1/0):1 w p pt 7 ps 0.1 lc rgb "#eeeeee" t "", "../goals.dat" u 1:2:(0.2) w circles fs transparent border rgb "#32cd32" lw 0.2 lt -1 lc rgb "#32cd32" t "", "../landmarks.dat" u 1:2:(0.1) w circles fs transparent border rgb "red" lw 0.1 lt -1 lc rgb "red" t "", "../landmarks.dat" u 1:2:(0.5) w circles fs transparent border rgb "blue" lw 0.1 lt 2 lc rgb "blue" t "", "../home.dat" u 1:2:(0.2) w circles fs transparent border rgb "#444444" lt -1 lc rgb "#444444" lw 0.2 t "", "../agent.dat" u 3:(($1<=LAST && $1>=FIRST)&&$10>0.1?$4:1/0) w p ps 0.05 pt 7 lc rgb "violet" notitle, "../agent.dat" u 3:(($1<=LAST && $1>=FIRST)&&$11>0.1?$4:1/0) w p ps 0.05 pt 7 lc rgb "green" notitle
